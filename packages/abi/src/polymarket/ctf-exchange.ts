export const ctfExchangeAbi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'newOperatorAddress', type: 'address' },
      { indexed: true, internalType: 'address', name: 'admin', type: 'address' },
    ],
    name: 'NewOperator',
    type: 'event',
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'oldProxyFactory', type: 'address' },
      { indexed: true, internalType: 'address', name: 'newProxyFactory', type: 'address' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'removedOperator', type: 'address' },
      { indexed: true, internalType: 'address', name: 'admin', type: 'address' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'oldSafeFactory', type: 'address' },
      { indexed: true, internalType: 'address', name: 'newSafeFactory', type: 'address' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'uint256', name: 'token0', type: 'uint256' },
      { indexed: true, internalType: 'uint256', name: 'token1', type: 'uint256' },
  ...
  { inputs: [], name: 'pauseTrading', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'paused',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
  ...
  { inputs: [], name: 'renounceOperatorRole', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'safeFactory',
    outputs: [{ internalType: 'address', name: '', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'address', name: '_newProxyFactory', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'address', name: '_newSafeFactory', type: 'address' }],
    name: 'setSafeFactory',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  { inputs: [], name: 'unpauseTrading', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
      { internalType: 'uint256', name: 'token', type: 'uint256' },
      { internalType: 'uint256', name: 'complement', type: 'uint256' },
